...
ImportMessageLiteDefaultTypeInternal _ImportMessageLite_default_instance_;
...
void protobuf_InitDefaults_google_2fprotobuf_2funittest_5fimport_5flite_2eproto() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &protobuf_InitDefaults_google_2fprotobuf_2funittest_5fimport_5flite_2eproto_impl);
}
